 ...
 * view it.
 */
public class MainActivity extends LifecycleLoggingActivity implements View.OnClickListener {
    /**
    ...
    public void downloadImage(View view) {
        try {
            ...
            Uri getUserUrl = this.getUrl();
            Intent downloadImageIntent = this.makeDownloadImageIntent(getUserUrl);
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
            	...
            	String imagePath = b.getString("downloadedImage");
            	Intent galleryIntent = this.makeGalleryIntent(imagePath);
            	...
            	Toast.makeText(this, "There was an issue with the result.", Toast.LENGTH_LONG).show();
            }
        }
    }    
