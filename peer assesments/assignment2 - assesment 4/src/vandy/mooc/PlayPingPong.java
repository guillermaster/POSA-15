...
public class PlayPingPong implements Runnable {
     ...
     * HandlerThreads.
     */
    Handler[] handlers = new Handler[PingPong.values().length];
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
            ...
            if (mMyType == PingPong.PING) {
                Handler pingHandler = handlers[PingPong.PING.ordinal()];
                Handler pongHandler = handlers[PingPong.PONG.ordinal()];
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            // the reply.
            Handler myHandler = handlers[mMyType.ordinal()];
