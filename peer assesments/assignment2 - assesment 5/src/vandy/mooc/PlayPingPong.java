...
public class PlayPingPong implements Runnable {
    ...
    private EnumMap<PingPong, Handler> players = new EnumMap<PingPong, Handler>(PingPong.class);
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
            ...
            // @@ TODO - you fill in here.
            players.put(mMyType, new Handler(getLooper(), this));
            ...
            // @@ TODO - you fill in here.
            if(mMyType.equals(PingPong.PONG)) {
                Message ball = Message.obtain();
                ball.obj = players.get(PingPong.PONG);
                ball.setTarget(players.get(PingPong.PING));
                ball.sendToTarget();
            }
        }
